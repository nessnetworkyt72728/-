...
local Players = {
    {Enabled = true,  Char = "character_c018",       Name = "Nibi",                      Team = 0, IsBot = false, BotDifficulty = 4, MinDifficulty = 0.5, MaxDifficulty = 0.8},
    {Enabled = true,  Char = "character_garnet",       Name = "I BOT 1 MILLION TOASTS!!!", Team = 0, IsBot = true,  BotDifficulty = 4, MinDifficulty = 3.0, MaxDifficulty = 3.0},
    {Enabled = false, Char = "character_finn",         Name = "Botso",                     Team = 1, IsBot = true,  BotDifficulty = 4, MinDifficulty = 0.5, MaxDifficulty = 3.0},
